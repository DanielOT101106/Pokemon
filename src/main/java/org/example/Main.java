...
public class Main {
    public static void main(String[] args) {
        ...
        Pokemon charmander = new Pokemon("Charmander", stats1, "Fire", moves1, null);

        Stats stats2 = new Stats(110, 48, 50, 60, 65, 43);
        List<Move> moves2 = List.of(tackle, waterGun);
        Pokemon squirtle = new Pokemon("Squirtle", stats2, "Water", moves2, null);

        Stats stats3 = new Stats(105, 52, 49, 60, 65, 45);
        List<Move> moves3 = List.of(tackle, vineWhip);
        Pokemon bulbasaur = new Pokemon("Bulbasaur", stats3, "Grass", moves3, null);
